...
<section id="hero" class="hero section dark-background">
    ...
    <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <?php foreach($rowSliders as $key => $val): ?>
        <div class="carousel-item <?php echo $key === 0 ? 'active' : '' ?>">
            <img src="admin/uploads/<?php echo $val['image'] ?>" alt="" class="img-fluid object-fit-cover">
            <div class="container">
    ...
    <div class="container">
        ...
        <div class="row position-relative">
            ...
            <div class="col-lg-7 about-img" data-aos="zoom-out" data-aos-delay="200">
                <img src="admin/uploads/<?php echo $rowAbout['image'] ?>">
            </div>
...
<section id="clients" class="clients section">
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row g-0 clients-wrap">
            ...
            <?php foreach($rowClients as $key => $val): ?>
            <div class="col-xl-3 col-md-4 client-logo">
                <img src="admin/uploads/<?php echo $val['image']?>" class="img-fluid" alt="">
            </div>
            <?php endforeach ?>
        </div>
