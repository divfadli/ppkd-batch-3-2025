        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="card-title d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div>
                        <a href="{{ route('anggota.index-restore') }}" class="btn btn-primary">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('anggota.edit', $val->id) }}" class="btn btn-sm btn-success me-1">
                                    Edit
                                </a>
                                <form action="{{ route('anggota.soft-deleted',$val->id) }}" method="post" class="d-inline"
