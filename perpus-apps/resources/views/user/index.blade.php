        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="card-title">{{ $thirdtitle ?? 'Data User' }}</h3>
                    <div align="right">
                        <a href="{{ route('user.create') }}" class="btn btn-primary mt-2 mb-2">
                        ...
                        <tbody>
                            @forelse ($users as $index => $val)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('user.roles', $val->id) }}" class="btn btn-sm btn-warning me-1">
                                            Tambah Role
                                        </a>
