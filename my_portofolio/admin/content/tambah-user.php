                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="name" id="" placeholder="Masukkan nama anda"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" name="email" id=""
                                ...
                                value="<?php echo ($id) ? $rowEdit['email'] : null ?>">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <a href="?page=user" class="text-muted btn btn-secondary">Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
